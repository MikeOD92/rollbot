...
# from dice_roll import Dice_commands
...
class MyClient(discord.Client):
    ...
    async def on_message(self, message):
        ...
        msg = message.content
        # rollhandler = Dice_commands(message, client)
